...
messagebox.showwarning(f"Restart {AppName}","You will need to restart {AppName} by saving and closing. Only AFTER will the additional features be implemented.")
